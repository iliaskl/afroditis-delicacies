            ...
            <div className="checkout-left">
              ...
              <section className="checkout-section">
                ...
                <div className="payment-options">
                  ...
                  >
                    <span className="payment-option-icon"><img src="./../../src/img/payment/paypal.png" alt="PayPal" /></span>
                    <span>PayPal</span>
                  ...
                  >
                    <span className="payment-option-icon"><img src="./../../src/img/payment/venmo.png" alt="Venmo" /></span>
                    <span>Venmo</span>
                    {paymentMethod === "venmo" && (
                      <a
                  ...
                  >
                    <span className="payment-option-icon"><img src="./../../src/img/payment/money.png" alt="Cash on Delivery" /></span>
